...
parser.add_argument('--description', type=str, default="", help='add more description')
...
try : torch.cuda.manual_seed_all(args.seed)
except : pass
# ========================================================================
...
description = str(instance_per_class)+"instance_per_class"+"_lr_"+str(args.lr)+"_adam_"+str(args.adam)+"_cosine_"+str(args.cosine_annealing)+"_nhid_"+str(args.nhid)+"_wdrop_"+str(args.wdrop) + "_trainHidden_"+str(args.training_hidden_state)+"_multiLM_"+str(args.support_LMs)+"_pooling_"+str(pooling)+"_clip_"+str(clip)+"_description_"+str(args.description)
